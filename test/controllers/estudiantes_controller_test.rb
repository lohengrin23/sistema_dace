...
class EstudiantesControllerTest < ActionController::TestCase
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post :create, estudiante: { apellido: @estudiante.apellido, cedula: @estudiante.cedula, especialidad: @estudiante.especialidad, expediente: @estudiante.expediente, nombre: @estudiante.nombre }
    end
  ...
  test "should update estudiante" do
    patch :update, id: @estudiante, estudiante: { apellido: @estudiante.apellido, cedula: @estudiante.cedula, especialidad: @estudiante.especialidad, expediente: @estudiante.expediente, nombre: @estudiante.nombre }
    assert_redirected_to estudiante_path(assigns(:estudiante))
  end
