class EstudiantesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @estudiante.save
        format.html { redirect_to @estudiante, notice: 'Estudiante fue creado con exito.' }
  ...
  def update
    respond_to do |format|
      if @estudiante.update(estudiante_params)
        format.html { redirect_to @estudiante, notice: 'Estudiante fue actualizado con exito.' }
  ...
  def destroy
    @estudiante.destroy
    respond_to do |format|
      format.html { redirect_to estudiantes_url, notice: 'Estudiante ue eliminado con exito.' }
  ...
  private
    ...
    def estudiante_params
      params.require(:estudiante).permit(:nombre, :apellido, :cedula, :expediente, :especialidad)
    end
end
